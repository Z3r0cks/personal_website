...
module.exports.migrateDataBase = function () {
   con.connect(function (err) {
      ...
      con.query(`CREATE TABLE ${dataBase.tableName} (ID INT AUTO_INCREMENT PRIMARY KEY, PUP_NAME VARCHAR(255), DEV_NAME VARCHAR(255), SETTINGS VARCHAR(255))`, function (err, result) {
         if (err) throw err;
