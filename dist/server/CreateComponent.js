...
module.exports.createComponent = function () {
   ...
   class Create${config_name_pascal} extends Migration {
      constructor() {
        ...
        fs_1.default.appendFile(`src/server/Migrations/create_c_${config_name}_table.ts`, Migration, function (err) {
            if (err)
                throw err;
            console.log(`Migration File C_${config_name} is created successfully.`);
        });
        fs_1.default.appendFile(`src/ts/frontend/components/C_${config_name}.ts`, content, function (err) {
            if (err)
                throw err;
